...
/**
 * ArrayListExample.java - this is the ArrayList example that Mr.Wachs did with us
 * in class to review it.
 * 
...
public class ArrayListExample 
{
    ...
    public static void main(String[] args) {
        ...
        index = 3;
        System.out.println("mehtod get(3) = " + list.get(index));
        
        index = 0;
        System.out.println("mehtod get(0) = " + list.get(index));
        
        index = list.size()-1;
        System.out.println("mehtod get(size()-1) = " + list.get(index));
        ...
        for (int i = 0; i < list.size(); i++) {
            System.out.println("'for loop' with array list: " + list.get(i));
        }
