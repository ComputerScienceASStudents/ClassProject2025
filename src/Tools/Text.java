 ...
 * @author Thomas Paterson
  * @since Dec 18, 2024, 11:28:09 a.m.
 */
public class Text 
{
     ...
     * @return an array of random words
     */
    public String[] randomWordSize(int size, int length, boolean par) {
        String[] strings = new String[size];    // create empty array 
        for (int i = 0; i < size; i++) {        // traverse array size
    ...
    public LinkedList<String> randomList(int size, int length) {
        return new LinkedList<String>(randomWordSize(size, length, true));
    }
