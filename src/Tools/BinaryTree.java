 ...
 * BinaryTreeNode class to connect into a traditional binary tree. It could be
 * visualized as:
 *                               +------+
 *                               | root |
 *                               +------+
...
* @since Dec 17, 2024, 11:38:40 a.m.
 */
public class BinaryTree <T extends Comparable<T> > implements Serializable
{

    private BinaryTreeNode<T> root;               // The root of tree
    ...
    public boolean insert(T data) {
        ...
        if (root == null) root = new BinaryTreeNode<>(data);  // Inserting first item
     ...
     */
    private boolean recursiveSearch(T data, BinaryTreeNode<T> current) {
     ...
     */
    private LinkedList<T> recursivePreOrderTraversal(BinaryTreeNode<T> current) {
     ...
     * @param current the reference to the current tree node
     */
    private LinkedList<T> recursivePostOrderTraversal(BinaryTreeNode<T> current) {
     ...
     * @param current the reference to the current tree node
     */
    private LinkedList<T> recursiveInOrderTraversal(BinaryTreeNode<T> current) {
